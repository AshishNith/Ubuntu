...
const Settings = ({ isVisible, setShowSettings }) => {
    ...
    >
      ...
      <div className='window-header h-12 bg-gray-950 rounded-t-xl flex items-center justify-between px-4 cursor-move'>
        ...
        <div className='flex items-center gap-2'>
          <i onClick={() => setShowSettings(false)} className="ri-close-fill text-white hover:bg-gray-800/50 p-2 rounded-full cursor-pointer"></i>
        </div>
      </div>
      ...
      <div className='flex h-[calc(100%-48px)]'>
        ...
        <div className='flex-1 p-6'>
          ...
          <p className='text-gray-600'>Select a category from the sidebar to view and modify settings.</p>
        </div>
      </div>
    </div>
  )
